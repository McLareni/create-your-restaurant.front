  ...
  return (
    <Card className={`p-5! ${!member.isActive ? 'border-brand-gray/20 opacity-80 grayscale-20' : ''}`}>
      ...
      <div className="flex flex-col gap-2.5 flex-1 mb-5 relative z-0">
        <div className="flex items-center gap-3 text-sm text-brand-gray dark:text-brand-gray/80">
      ...
      <div className="mt-auto border-t border-brand-gray/10 dark:border-brand-gray/20 pt-4 flex items-center justify-between relative z-0">
        <span className={`text-xs font-medium ${member.isActive ? 'text-green-600 dark:text-green-500' : 'text-red-500 dark:text-red-400'}`}>
