...
export const PinPad = ({ onConfirm, isLoading }: PinPadProps) => {
  ...
  return (
    <div className="flex flex-col gap-4 bg-brand-mocha p-4 rounded-2xl border border-brand-gray/10 shadow-lg max-w-xs mx-auto">
      <div className="bg-brand-espresso h-12 rounded-xl border border-brand-gray/20 flex items-center justify-center text-xl font-mono text-brand-gold font-bold tracking-widest">
        {'*'.repeat(pin.length) || '-'}
      </div>
      <div className="grid grid-cols-3 gap-2">
        ...
        <Button
          type="button"
          variant="outline"
          className="h-12 font-bold text-lg text-brand-cream border-brand-copper/30"
