...
export const LiveMonitorCard = ({
  ...
  return (
    <div
      className={`group relative flex h-min w-full flex-col justify-between overflow-visible rounded-xl border bg-white p-4 shadow-sm transition-all hover:border-brand-copper/30 hover:shadow-md dark:border-brand-gray/20 dark:bg-brand-mocha ${
        isExpanded
    ...
    >
      ...
      {isExpanded ? (
        <div
          className="absolute -left-px -right-px z-30 top-[calc(100%-1px)] space-y-3 rounded-b-xl border border-t-0 border-brand-copper/30 bg-white p-3 dark:border-brand-gray/20 dark:bg-brand-mocha"
        >
