...
export const InventoryTab = () => {
  ...
  return (
    <div className="flex h-full flex-col p-4 relative select-none">
      ...
      <div className="flex-1 overflow-hidden rounded-xl border border-brand-gray/20 dark:border-brand-gray/20 bg-white dark:bg-brand-mocha flex flex-col z-0">
