...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-brand-espresso selection:bg-brand-copper selection:text-white relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-[0.015] bg-[radial-gradient(#E6C687_1px,transparent_1px)] bg-size-[32px_32px]" />
      </div>
      ...
      <div className="relative z-10 flex w-full flex-col lg:flex-row">
        ...
        <div className="hidden lg:flex w-1/2 flex-col justify-center p-16 text-brand-cream min-h-screen relative">
          <div className="max-w-xl">
            <h2 className="mb-6 text-5xl lg:text-6xl font-serif font-bold leading-[1.15] tracking-tight text-white whitespace-pre-line">
              {t('auth.login.title')}
            </h2>
          ...
          <div className="absolute bottom-16 left-16 right-16 border-t border-white/10 pt-6 flex gap-6 text-xs text-brand-gray/80 font-medium">
            ...
            <a href="/terms" className="text-brand-gold hover:text-white transition-colors">Terms</a>
            <a href="/privacy" className="text-brand-gold hover:text-white transition-colors">Privacy</a>
          </div>
        </div>
